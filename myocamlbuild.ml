(* OASIS_START *)
(* DO NOT EDIT (digest: ee89d882baea3c284c95f520926b1ace) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("scry", ["lib"], [])];
     lib_c = [];
     flags =
       [
          (["oasis_library_scry_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_scry_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_scry_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_scry_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_scry_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_scry_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])])
       ];
     includes = []
  }
